export const PRESET_ROLES = [
  {
    ...
    description: `We are looking for a skilled Frontend Developer to join our team. The ideal candidate will be responsible for building the client-side of our web applications. You should be able to translate our company and customer needs into functional and appealing interactive applications.
...
- Good understanding of asynchronous request handling, partial page updates, and AJAX.`
  },
  {
    ...
    description: `We are seeking an experienced Backend Developer to join our IT team. You will be responsible for the server-side of our web applications. If you have excellent programming skills and a passion for developing applications or improving existing ones, we would like to meet you.
...
- Familiarity with databases (e.g. MySQL, MongoDB), web servers (e.g. Apache) and UI/UX design.`
  },
  {
    ...
    description: `We are looking for a DevOps Engineer to help us build functional systems that improve customer experience. DevOps Engineer responsibilities include deploying product updates, identifying production issues and implementing integrations that meet customer needs.
...
- Experience using business intelligence tools (e.g. Tableau) and data frameworks (e.g. Hadoop).`
  },
  {
    ...
    description: `We are looking for an experienced Product Manager to be responsible for setting the strategy, roadmap, and feature definition for a product or product line. You will guide the success of a product and lead the cross-functional team that is responsible for improving it.
...
- Proficiency in HTML, CSS, and JavaScript for rapid prototyping.`
  },
  {
    ...
    description: `We are looking for an experienced Project Manager to manage organization of key client projects. Project Manager responsibilities include the coordination and completion of projects on time within budget and within scope. Oversee all aspects of projects. Set deadlines, assign responsibilities and monitor and summarize progress of project.
...
- Solid organizational skills including attention to detail and multi-tasking skills.`
  },
  {
    ...
    description: `We are looking for a Marketing Manager to be responsible for developing, implementing and executing strategic marketing plans for an entire organization (or lines of business and brands within an organization) in order to attract potential customers and retain existing ones.
...
- Working knowledge of the general mobile landscape, architectures, trends, and emerging technologies.`
  },
  {
    ...
    description: `We are looking for a skilled Database Administrator (DBA) who will be responsible for the performance, integrity, and security of our databases. You will also be involved in the planning and development of the database, as well as troubleshooting any issues on behalf of the users.
...
- Experience with DBA case tools (frontend/backend) and third-party tools.`
  },
  {
    ...
    description: `We are looking for a Business Analyst to join our team. The main role of the Business Analyst is to analyze the business processes, identify areas of improvement, and recommend solutions to business problems.
...
- Familiarity with project management methodologies like Agile and Scrum.`
  },
  {
    ...
    description: `We are seeking an IT Support Specialist to provide technical assistance and support to our employees. You will be the first point of contact for any technical issues, and you'll work to resolve them in a timely and efficient manner.
...
- Hands-on experience with monitoring, network diagnostic, and network analytics tools.`
  },
  {
    ...
    description: `We are seeking a Cybersecurity Analyst to protect our computer networks and systems. You will be responsible for identifying and mitigating security threats, implementing security measures, and responding to security incidents.
...
- Strong analytical and problem-solving skills.`
  },
  {
    ...
    description: `We are looking for a Content Strategist to oversee all marketing content initiatives to ensure customer engagement, brand consistency and a positive customer experience. You will be responsible for creating and implementing a content strategy that aligns with our business goals.
...
- Excellent writing and editing skills in English.`
  },
  {
    ...
    description: `We are looking for a Digital Marketing Specialist to assist in the planning, execution, and optimization of our online marketing efforts. The ideal candidate will have a passion for all things marketing and technology.
...
- Perfect knowledge of web analytics tools (e.g., Google Analytics, NetInsight, WebTrends etc.).`
  },
  {
    ...
    description: `We are looking for an HR Manager to oversee all aspects of human resources practices and processes. You will support business needs and ensure the proper implementation of company strategy and objectives.
...
- Ability to architect strategy along with leadership skills.`
  },
  {
    ...
    description: `We are looking for a Financial Analyst to provide accurate and data-based information on company’s profitability, solvency, stability and liquidity. You will research and analyze financial information to help the company make well-informed decisions, write reports and monitor financial movements.
...
- BS degree in Finance, Economics or related field.`
  },
  {
    ...
    description: `We are looking for a creative Graphic Designer with up-to-date knowledge to interpret our clients’ needs and to design solutions with high visual impact. You will work on a variety of products, including websites, books, magazines, product packaging, websites, exhibitions, corporate identity etc.
...
- Excellent communication skills.`
  },
  {
    ...
    description: `We are looking for a Customer-oriented Service Representative. A customer service representative, or CSR, will act as a liaison, provide product/services information and resolve any emerging problems that our customer accounts might face with accuracy and efficiency.
...
PRESET_ROLES.push(...additionalRoles);
// Sort alphabetically by title
PRESET_ROLES.sort((a, b) => a.title.localeCompare(b.title));