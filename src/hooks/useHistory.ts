...
export const useHistory = (): {
  ...
  addHistoryEntry: (data: Omit<HistoryEntry, 'id' | 'timestamp' | 'title'>) => void;
  ...
  const addHistoryEntry = useCallback((data: { jobDescription: string; resumes: Resume[]; analysisResults: Candidate[] }) => {
